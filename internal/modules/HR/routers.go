...
func (S *HRService) registerRoutes() {
	...
	hrRoute.GET("/employeesalary", S.getEmployeeSalary, rba.AuthMiddelware([]string{"admin", "emp", "mod"}))
	hrRoute.GET("/employeeallowances", S.getEmployeeAllowances, rba.AuthMiddelware([]string{"admin", "emp", "mod"}))
