...
func (q *Queries) GetEmpAirticketReqByBranchAndStatus(ctx context.Context, arg GetEmpAirticketReqByBranchAndStatusParams) ([]EmpAirticketReq, error) {
...
func (q *Queries) GetEmpAirticketReqByStatus(ctx context.Context, arg GetEmpAirticketReqByStatusParams) ([]EmpAirticketReq, error) {
